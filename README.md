...
If all the fields are required to register a new user, system should generate relevant validation error when any of the field values are missing.
...
2. Add/remove items to the cart
3. Update the cart
